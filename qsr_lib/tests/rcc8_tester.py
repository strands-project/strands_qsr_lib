...
class RCC8_Test(Abstractclass_Unittest_Dyadic):
    def __init__(self, *args):
        super(RCC8_Test, self).__init__(*args)
    ...
    def test_defaults(self):
        self.assertItemsEqual(*self.defaults("data1", "data1_rcc8_defaults.txt"))

    def test_qsrs_for_global_namespace(self):
        self.assertItemsEqual(*self.qsrs_for_global_namespace("data1", "data1_rcc8_qsrs_for_global_namespace.txt"))

    def test_qsrs_for_qsr_namespace(self):
        self.assertItemsEqual(*self.qsrs_for_qsr_namespace("data1", "data1_rcc8_qsrs_for_qsr_namespace.txt"))
        # precedes "for_all_qsrs" namespace
        self.assertItemsEqual(*self.qsrs_for_qsr_namespace_over_global_namespace("data1",
                                                                                 "data1_rcc8_qsrs_for_qsr_namespace.txt"))
    ...
    def test_without_bounding_boxes(self):
        self.assertItemsEqual(*self.defaults("data3", "data3_rcc8_defaults.txt"))

    def test_floats(self):
        self.assertItemsEqual(*self.defaults("data4", "data4_rcc8_defaults.txt"))

    def test_custom(self):
        self.assertItemsEqual(*self.custom("data1", "data1_rcc8_custom.txt", self.__custom))

if __name__ == '__main__':
    import rosunit
    rosunit.unitrun("qsr_lib", "rcc8_test", RCC8_Test, sys.argv)
