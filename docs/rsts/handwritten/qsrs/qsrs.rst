...
+================+===================================================+=========================================================================================================+================+
| **argd**       | Qualitative Distance System                       | :doc:`descr. <argd>` \| :mod:`api <qsrlib_qsrs.qsr_arg_relations_distance>`                             | [7]_           |
+----------------+---------------------------------------------------+---------------------------------------------------------------------------------------------------------+----------------+
| **argprobd**   | Probablistic Qualitative Distance System          | :doc:`descr. <argprobd>` \| :mod:`api <qsrlib_qsrs.qsr_arg_prob_relations_distance>`                    |                |
+----------------+---------------------------------------------------+---------------------------------------------------------------------------------------------------------+----------------+
| **cardir**     | Cardinal Direction                                | :doc:`descr. <cardir>` \| :mod:`api <qsrlib_qsrs.qsr_cardinal_direction>`                               | [1]_           |
+----------------+---------------------------------------------------+---------------------------------------------------------------------------------------------------------+----------------+
